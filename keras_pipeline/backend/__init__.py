...
def bbox_transform_inv(boxes, deltas, mean=None, std=None):
    """Adjust boxes based on deltas

    Args
        boxes  : collection of box in the format (x1, y1, x2, y2)
        deltas : amount of shifting needed to be done to each box
        mean   : fixed distance to shift in each direction
        std    : degree of effect of deltas

    Returns
        Tensor containing boxes shifted based on deltas
