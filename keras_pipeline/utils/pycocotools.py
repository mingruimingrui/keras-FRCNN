...
class COCO:
    """ Custom made pycocotools.coco.COCO for reading and processing of dataset """
    def __init__(self, annotation_file):
        # Load data from annotation file into self
    ...
    def _load_data(self, annotation_file):
        ...
        # Load data from self.dataset into self
    ...
    def download(self, tarDir=None, imgIds=[]):
        raise NotImplementedException('download has not been implemented, please download COCO dataset from http://cocodataset.org/#download')
