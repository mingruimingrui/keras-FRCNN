...
def load_datasets(args):
    ...
    train_set      = DetectionDataset(args.kitti_path, 'person_instances_local_train.json', 'training')
    validation_set = DetectionDataset(args.kitti_path, 'person_instances_local_val.json'  , 'training')
...
def parse_args(args):
    ...
    parser.add_argument(metavar='KITTI_PATH', dest='kitti_path',
