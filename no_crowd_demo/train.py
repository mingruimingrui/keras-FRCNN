...
def load_datasets(args):
    ...
    train_set      = DetectionDataset(args.coco_path, 'instances_nocrowd_train2017.json', 'train2017')
    validation_set = DetectionDataset(args.coco_path, 'instances_nocrowd_val2017.json'  , 'val2017'  )
